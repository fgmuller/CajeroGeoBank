...
sonidos.entrega.play();
  resultado.innerHTML = "Total de Dinero: $" + total + "<hr />";
    var r =document.getElementById("dinero");
  retiro = parseInt(r.value);

  resultado2.innerHTML = "Retirado: $" + retiro;
resultado3.innerHTML = "Nuevo Saldo Total de Dinero: $" + (total-retiro) + "<hr />";

  if (dinero > 0)
  {

    resultado.innerHTML ="Soy un cajero malo, muy malo y no te daré esa cantidad!!! ";
  }
  else {
    {
     ...
     {
resultado4.innerHTML += "<img src=" + e.imagen.src + " />"+ "<hr />";
...
var boton_extraccion = document.getElementById("botonExtraccion");
var recibito=document.getElementById("resultado5");
...
function generarFactura() {
 ...
 recibo.innerHTML += "<img src=facturaCabeza.png>" ;
...
recibo.innerHTML += "<img src=facturaPie.png>" ;
